...
exports.main = async(event, context) => {
  ...
  try {
    ...
    //if (event.e = "getpassword"){               //for login
      ...
      const [rows, fields] = await connection.execute("SELECT s.sno,sname,st.tno,tname,sphone,tphone from s left join st on s.sno = st.sno left join t on st.tno = t.tno")
      console.log(rows)
      return rows;
    //}
